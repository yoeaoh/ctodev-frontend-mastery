...
import { FiberTreeWalkthrough } from './components/visualizations/FiberTreeWalkthrough';
import { KeyStabilityDemo } from './components/visualizations/KeyStabilityDemo';
          ...
          <main className="max-w-6xl mx-auto space-y-40 py-12 pb-32">
            ...
            <section id="module-2" className="scroll-mt-24">
              <div className="flex flex-col gap-2 mb-12">
                ...
                <h2 className="text-5xl font-black tracking-tight mb-4">Reconciliation & Fiber</h2>
                <p className="text-zinc-500 max-w-2xl leading-relaxed text-lg">
                  Virtual DOM is a data structure, not a magic trick. Explore the <strong>Diffing Algorithm</strong> and the <strong>Fiber Work Loop</strong> that powers modern React.
                </p>
              </div>
              ...
              <div className="space-y-32">
                <div className="space-y-8">
                  <div className="flex flex-col gap-4">
                    <h3 className="text-3xl font-bold tracking-tight">Live VDOM Diffing</h3>
                    <p className="text-zinc-500 leading-relaxed max-w-3xl">
                      See how React identifies changes between two renders. Observe the exact <strong>DOM Patches</strong> (Update, Insert, Delete) generated by the reconciler.
                    </p>
                  </div>
                  <VDOMDiffVisualizer />
                </div>
                ...
                <div className="space-y-8">
                  <div className="flex flex-col gap-4">
                    <h3 className="text-3xl font-bold tracking-tight">Fiber Tree Walkthrough</h3>
                    <p className="text-zinc-500 leading-relaxed max-w-3xl">
                      React Fiber turns recursive rendering into a linked-list traversal. This enables <strong>Time Slicing</strong>: React can pause long-running work to handle user input.
                    </p>
                  </div>
                  <FiberTreeWalkthrough />
                </div>

                <div className="space-y-8">
                  <div className="flex flex-col gap-4">
                    <h3 className="text-3xl font-bold tracking-tight">Key Stability Demo</h3>
                    <p className="text-zinc-500 leading-relaxed max-w-3xl">
                      Keys aren't just for performance; they are identity anchors. Compare how using <code className="text-rose-400 bg-rose-400/10 px-1 rounded">index</code> vs <strong>Unique IDs</strong> affects DOM permanence and state.
                    </p>
                  </div>
                  <KeyStabilityDemo />
                </div>
